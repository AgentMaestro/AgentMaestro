...
_TOOL_RESPONSE_FIELDS = {
    ...
    "spawn_subrun": {
        ...
        "completed_inline": "False for the normal queued background flow; kept for compatibility with older callers.",
        "queued": "True when the child was queued for background execution instead of being run inline.",
        "resumed_parent": "True when the parent left WAITING_FOR_SUBRUN during the tool call.",
        "child_final_text": "Final assistant text produced by the child when available.",
        "child_error_summary": "Child error summary when the child failed or returned an error.",
        ...
        "fallback_notice": "Short human-readable guidance returned for background queued or failure scenarios.",
    },
    "get_current_datetime": {
    ...
    },
    {
        ...
        "tools": [
            ...
            },
            {
                ...
                "description": "Launch an existing scheduled task immediately without changing its recurrence. If the task needs approval, the launch pauses at the same approval gate used by scheduled execution.",
                "risk": ToolRisk.SAFE,
                "args_schema": {
                    "type": "object",
                    "additionalProperties": False,
            ...
            },
            {
                ...
                "description": "List all recurring tasks in the workspace. Set include_execution_payload=true when you need to preview the stored payload alongside the scheduling metadata.",
                "risk": ToolRisk.SAFE,
                "args_schema": {
                    "type": "object",
                    "additionalProperties": False,
